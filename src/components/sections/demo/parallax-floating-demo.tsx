...
export default function ParallaxFloatingShapes() {
  return (
    <div className="relative mx-auto flex min-h-[500px] w-full max-w-xl items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-violet-500/5 via-transparent to-indigo-500/5">
...
export { ParallaxFloatingShapes as ParallaxFloatingDemo }
