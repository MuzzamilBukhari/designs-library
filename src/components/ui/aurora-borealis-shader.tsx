...
const AuroraBorealisShader = () => {
  ...
  return (
    <>
      <div
        ref={containerRef}
        className="shader-container absolute inset-0 z-0 pointer-events-auto"
        aria-label="Aurora Borealis animated background"
      />
      {/* Optional cursor light */}
      <div
        className="cursor-light pointer-events-none absolute w-5 h-5 rounded-full bg-white/50 -translate-x-1/2 -translate-y-1/2 z-10"
        style={{
