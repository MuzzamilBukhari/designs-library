...
const TestimonialSlider: React.FC = () => {
  ...
  return (
    <div className="px-4 py-8 sm:py-16 bg-gradient-to-b from-gray-50 to-white dark:from-zinc-950 dark:to-zinc-900 overflow-hidden">
          ...
          <div className="flex justify-center sm:justify-end sm:absolute sm:-top-16 right-0 space-x-2 mb-4 sm:mb-0">
            <motion.button
              ...
              className={`p-2 rounded-full ${
                canGoPrev 
                  ? 'bg-white dark:bg-zinc-800 shadow-md hover:bg-gray-50 dark:hover:bg-zinc-700 text-primary dark:text-primary-light' 
          ...
          <div className="overflow-hidden relative px-2 sm:px-0">
            ...
            >
              {testimonials.map((testimonial) => (
                ...
                >
                  <motion.div 
                    className="relative overflow-hidden rounded-xl sm:rounded-2xl p-4 sm:p-6 h-full bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 shadow-lg shadow-primary/5 dark:shadow-primary-light/5"
                    whileHover={{
                  ...
                  >
                    ...
                    <div className="relative z-10 h-full flex flex-col">
                      ...
                      <div className="mt-auto pt-3 sm:pt-4 border-t border-gray-100 dark:border-zinc-800">
