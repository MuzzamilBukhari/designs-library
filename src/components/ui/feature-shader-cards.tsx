...
const features: Feature[] = [
  ...
  },
  {
    ...
    icon: <SlidersHorizontal className="w-12 h-12 text-white" strokeWidth={1.5} />,
  },
  {
    title: "Responsive",
  ...
  },
  {
    ...
    icon: <Cpu className="w-12 h-12 text-white" strokeWidth={1.5} />,
  },
]
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <div key={index} className="relative h-80 group cursor-pointer">
                <div className="absolute inset-0 rounded-3xl overflow-hidden shadow-xl transition-transform duration-500 group-hover:scale-[1.02]">
                  <Warp
                ...
                <div className="relative z-10 p-8 rounded-3xl h-full flex flex-col bg-black/60 hover:bg-black/40 transition-colors duration-500 border border-white/20 dark:border-white/10 backdrop-blur-[2px]">
