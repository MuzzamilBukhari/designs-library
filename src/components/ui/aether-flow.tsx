 ...
 */
const useShaderAnimation = (mountRef: React.RefObject<HTMLDivElement | null>, shaderProps: any) => {
 ...
 */
export const ShaderCanvas = (props: any) => {
 ...
 */
export const ControlSlider = ({ label, value, onChange, min, max, step }: any) => (
