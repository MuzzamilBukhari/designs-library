    ...
    <>
      ...
      <div className="halide-body">
        ...
        <div className="interface-grid">
          ...
          <div className="hidden sm:block" style={{ textAlign: 'right', fontFamily: 'monospace', color: 'var(--accent)', fontSize: '0.7rem' }}>
          ...
          <div style={{ gridColumn: '1 / -1', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem' }} className="sm:flex-row sm:items-end">
            <div style={{ fontFamily: 'monospace', fontSize: '0.75rem' }}>
              <p>[ ARCHIVE 2024 ]</p>
              <p className="hidden sm:block">SURFACE TENSION & TOPOGRAPHICAL LIGHT</p>
            </div>
